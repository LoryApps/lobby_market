...
import { Activity, BarChart2, Bell, BookOpen, Calendar, Coins, Compass, FileText, Flame, Gavel, HelpCircle, History, LayoutGrid, LogOut, MessageSquare, Network, Scale, Search, Plus, Settings, Skull, Sparkles, Star, Swords, Target, Timer, TrendingUp, User, Zap, ArrowUpRight, Globe, Users } from 'lucide-react'
