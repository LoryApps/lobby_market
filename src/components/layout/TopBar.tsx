...
import { Activity, BarChart2, Bell, BookOpen, Calendar, Coins, Compass, FileText, Flame, FlaskConical, Gavel, HelpCircle, History, LayoutGrid, LogOut, MessageSquare, Network, Scale, Scroll, Search, Plus, Settings, Skull, Sparkles, Star, Swords, Target, Timer, TrendingUp, User, Zap, ArrowUpRight, Globe, Users } from 'lucide-react'
