            ...
            >
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Link
                  ...
                  title="Printable civic report — vote split, founding arguments, wiki, and reviews"
                >
                ...
                <Link
                  ...
                  title="FOR and AGAINST arguments from the founding debate"
                >
                  <Scale className="h-3.5 w-3.5" />
                  Arguments
                </Link>
                ...
                <Link
                  ...
                  title="Civic Influence — citation network, downstream debates, and influence score"
                >
                  <Sparkles className="h-3.5 w-3.5" />
                  Influence
                </Link>
