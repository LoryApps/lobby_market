...
const QUICK_LINKS: QuickLink[] = [
  ...
  { type: 'link', id: 'predictions-analytics', label: 'Prediction Analytics', sublabel: 'Your prediction market record — accuracy, Brier score, calibration, and forecaster archetype', href: '/analytics/predictions', icon: Target, iconColor: 'text-purple', iconBg: 'bg-purple/10' },
