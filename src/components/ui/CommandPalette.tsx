...
const QUICK_LINKS: QuickLink[] = [
  ...
  {
    type: 'link',
    id: 'relay-uncontested',
    label: 'Uncontested Relays',
    sublabel: 'Topics with only one side argued — be the first to make the case for the other side',
  ...
  },
  {
    type: 'link',
    id: 'relay-top-legs',
    label: 'Top Relay Legs',
    sublabel: 'The most-starred individual relay legs — ranked by community upvotes',
  ...
  },
  {
    type: 'link',
    id: 'relay-champions',
    label: 'Relay Champions',
    sublabel: 'Top relay starters ranked by compelling votes and completed chains',
