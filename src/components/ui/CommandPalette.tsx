...
const QUICK_LINKS: QuickLink[] = [
  ...
  { type: 'link', id: 'civic-imposter', label: 'Civic Imposter', sublabel: 'Spot the fake law hiding among 5 real Codex laws — daily detection challenge', href: '/civic-imposter', icon: Search, iconColor: 'text-against-400', iconBg: 'bg-against-600/10' },
