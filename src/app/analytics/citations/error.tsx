...
export default function CitationsError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-20 pb-24 flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="font-mono text-lg font-semibold text-white mb-2">Citation data unavailable</h2>
        <p className="text-sm font-mono text-surface-500 max-w-sm mb-6">
          Could not load your citation analytics. Try again in a moment.
        </p>
