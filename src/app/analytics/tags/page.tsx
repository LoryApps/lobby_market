    ...
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-6 pb-24 md:pb-12">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 mb-6 text-xs font-mono">
          <Link href="/analytics" className="text-surface-500 hover:text-white transition-colors">&larr; Analytics</Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
            ...
            <div className="rounded-xl bg-surface-100 border border-surface-300 p-4 col-span-2">
              ...
              {data.most_voted_tag ? (
                ...
                <div className="text-sm font-mono text-surface-500">&mdash;</div>
              )}
            </div>
          </div>
        )}
