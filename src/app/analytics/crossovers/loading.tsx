...
export default function CrossoversLoading() {
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-6 pb-24 md:pb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <div className="h-6 w-40 rounded-lg bg-surface-200 animate-pulse mb-1" />
            <div className="h-4 w-56 rounded-lg bg-surface-200 animate-pulse" />
          </div>
        </div>
        <div className="rounded-2xl bg-surface-100 border border-surface-300 p-6 h-44 animate-pulse mb-4" />
        ...
        <div className="rounded-2xl bg-surface-100 border border-surface-300 p-6 h-48 animate-pulse mb-3" />
