...
export default function GrowthError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-12 pb-24 md:pb-12 flex flex-col items-center text-center">
        ...
        <h1 className="font-mono text-xl font-bold text-white mb-2">Couldn&apos;t load growth data</h1>
        <p className="text-sm text-surface-500 mb-6 max-w-xs">
          There was a problem fetching your activity data. Try again or head back to the analytics hub.
        </p>
