...
export default function CivicRegistryError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 pb-24 md:pb-12 flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h1 className="font-mono text-xl font-bold text-white mb-2">Registry unavailable</h1>
        <p className="font-mono text-sm text-surface-500 mb-6">
          An error occurred while loading the Civic Registry.
        </p>
