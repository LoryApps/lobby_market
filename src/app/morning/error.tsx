...
export default function MorningError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Morning page error:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-20 pb-28 md:pb-12 flex flex-col items-center text-center gap-4">
        ...
        <div className="space-y-1.5 max-w-xs">
          <p className="font-mono font-bold text-white text-lg">Morning brief unavailable</p>
          <p className="font-mono text-surface-500 text-sm">
            Something went wrong loading today's brief. Try refreshing.
          </p>
        </div>
