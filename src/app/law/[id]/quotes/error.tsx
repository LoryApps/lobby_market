    ...
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-8rem)] px-4 pb-24">
        <div className="max-w-sm w-full text-center space-y-5">
          ...
          <div>
            <p className="font-mono text-base font-semibold text-white mb-1">Failed to load quotes</p>
            <p className="text-xs font-mono text-surface-500">Could not fetch debate quotes for this law.</p>
          </div>
