...
export default function LawWikiHistoryError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[law-wiki-history] error:', error)
  }, [error])

  return (
    <div className="min-h-screen bg-surface-50">
      <TopBar />
      <main className="max-w-2xl mx-auto px-4 py-20 pb-24 md:pb-12 flex flex-col items-center justify-center text-center gap-5">
        ...
        <div className="space-y-1.5 max-w-xs">
          ...
          <p className="font-mono text-sm text-surface-500 leading-relaxed">
            Failed to load the wiki edit history. Try again or return to the law wiki.
          </p>
        </div>
