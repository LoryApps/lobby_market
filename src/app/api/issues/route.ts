...
// ─── Issue definitions ────────────────────────────────────────────────────────
// Each issue maps to one or more tags used in the topics.tags[] column.
// Tags are auto-generated lowercase keywords — see migration 00059_topic_tags.sql.

export interface CivicIssue {
  slug: string
  title: string
  description: string
  tags: string[]           // topic tags to match (OR logic)
  categories: string[]     // topic categories to match (OR logic, secondary filter)
