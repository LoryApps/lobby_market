...
export default function SessionDetailError({
  ...
  useEffect(() => {
    console.error('[WestminsterHallSession]', error)
  }, [error])

  return (
    <div className="min-h-screen bg-surface-50">
      <TopBar />
      <main className="max-w-2xl mx-auto px-4 pt-16 pb-28 md:pb-12 flex flex-col items-center text-center gap-5 mt-16">
