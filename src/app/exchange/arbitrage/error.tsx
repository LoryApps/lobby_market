...
export default function ArbitrageError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-950 text-white flex flex-col items-center justify-center gap-4 px-4">
      ...
      <h1 className="text-lg font-semibold text-surface-200">Failed to load arbitrage data</h1>
      <p className="text-sm text-surface-500 text-center max-w-xs">
        Could not fetch market data. This may be a temporary issue.
      </p>
