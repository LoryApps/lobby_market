...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/climate`,    changeFrequency: 'always', priority: 0.84 },
  { url: `${BASE_URL}/trajectory`, changeFrequency: 'always', priority: 0.83 },
  { url: `${BASE_URL}/doppler`,    changeFrequency: 'always', priority: 0.83 },
  ...
  { url: `${BASE_URL}/thesis/leaderboard`,     changeFrequency: 'daily',  priority: 0.78 },
  { url: `${BASE_URL}/thesis/analytics`,       changeFrequency: 'daily',  priority: 0.76 },
  { url: `${BASE_URL}/thesis/battle`,          changeFrequency: 'daily',  priority: 0.75 },
  { url: `${BASE_URL}/thesis/compare`,         changeFrequency: 'always', priority: 0.74 },
  { url: `${BASE_URL}/thesis/search`,          changeFrequency: 'always', priority: 0.74 },
  { url: `${BASE_URL}/thesis/alignment`,       changeFrequency: 'daily',  priority: 0.73 },
  { url: `${BASE_URL}/thesis/watching`,        changeFrequency: 'always', priority: 0.72 },
  { url: `${BASE_URL}/thesis/today`,           changeFrequency: 'daily',  priority: 0.76 },
  { url: `${BASE_URL}/thesis/expiring`,        changeFrequency: 'hourly', priority: 0.75 },
  { url: `${BASE_URL}/thesis/resolved`,        changeFrequency: 'daily',  priority: 0.74 },
  { url: `${BASE_URL}/thesis/my`,              changeFrequency: 'always', priority: 0.72 },
  { url: `${BASE_URL}/thesis/create`,          changeFrequency: 'monthly', priority: 0.65 },
