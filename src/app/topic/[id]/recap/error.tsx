...
export default function TopicRecapError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      <TopBar />
      <main className="max-w-2xl mx-auto px-4 pt-20 pb-24 flex flex-col items-center text-center gap-4">
        ...
        <h1 className="font-mono text-xl font-bold text-white">Couldn&apos;t load recap</h1>
        <p className="text-sm font-mono text-surface-500 max-w-sm">
          This recap is only available for topics that have been resolved (established as law or rejected by the community).
        </p>
