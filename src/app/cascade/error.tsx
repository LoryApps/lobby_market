...
export default function CascadeError({
  reset,
}: {
  error: Error
  reset: () => void
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-20 pb-24 flex flex-col items-center text-center gap-4">
        ...
        <p className="font-mono font-bold text-white">Cascade data unavailable</p>
        <p className="text-sm font-mono text-surface-500 max-w-xs">
          Something went wrong loading the cascade analysis. Try refreshing.
        </p>
