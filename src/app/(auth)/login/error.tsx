...
export default function LoginError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => { console.error('[LoginError]', error) }, [error])
  ...
  return (
    <div className="text-center py-8">
      ...
      <h1 className="font-mono text-lg font-bold text-white mb-2">Login unavailable</h1>
      <p className="text-sm text-surface-500 font-mono mb-6">
        Something went wrong loading the login page. Your data is safe.
      </p>
