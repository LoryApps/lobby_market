...
export default function EmergenceError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[EmergenceError]', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4">
      <div className="max-w-sm w-full text-center space-y-5">
        ...
        <div>
          <h1 className="font-mono text-xl font-bold text-white mb-2">Emergence unavailable</h1>
          <p className="text-sm text-surface-500 font-mono">
            Could not load emerging topics data. Try again in a moment.
          </p>
        </div>
