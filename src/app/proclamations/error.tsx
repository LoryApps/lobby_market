...
export default function ProclamationsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[ProclamationsError]', error)
  }, [error])

  return (
    <>
      <TopBar />
      <main className="min-h-screen bg-surface-50 pb-24 pt-14 flex items-center justify-center px-4">
        <div className="max-w-sm w-full text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-surface-500 font-mono leading-relaxed">
              Could not load the proclamations board. Please try again.
            </p>
          </div>
