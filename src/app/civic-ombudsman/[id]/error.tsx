...
export default function OmbudsmanCaseError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error('[OmbudsmanCaseError]', error) }, [error])
    ...
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4">
      <div className="max-w-sm w-full text-center space-y-5">
        ...
        <div className="space-y-2">
          <h1 className="font-mono text-lg font-bold text-white">Case not found</h1>
          <p className="text-sm text-surface-400">This Ombudsman case could not be loaded.</p>
        </div>
