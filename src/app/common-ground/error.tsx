...
import { AlertTriangle, HandshakeIcon, RefreshCw } from 'lucide-react'
...
export default function CommonGroundError({
  ...
  useEffect(() => {
    console.error('[CommonGroundPage]', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-16 pb-24 md:pb-12 flex flex-col items-center text-center gap-5">
        ...
        <div>
          <p className="font-mono font-bold text-white text-lg">Failed to load Common Ground</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald/20 border border-emerald/30 text-emerald text-sm font-mono hover:bg-emerald/30 transition-colors"
          >
