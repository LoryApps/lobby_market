...
export default function CoalitionChallengesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Coalition challenges error:', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-16 pb-24 flex flex-col items-center gap-5 text-center">
        ...
        <div>
          <h2 className="font-mono text-lg font-bold text-white mb-2">Failed to load challenges</h2>
          <p className="text-sm text-surface-400 max-w-xs">
            Something went wrong loading the Coalition Challenge Board. Try refreshing or going back.
          </p>
        </div>
