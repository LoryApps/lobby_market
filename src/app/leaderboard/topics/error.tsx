...
export default function TopicsLeaderboardError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 pb-24 md:pb-12 flex flex-col items-center text-center">
        ...
        <h1 className="font-mono text-xl font-bold text-white mb-2">Rankings unavailable</h1>
        <p className="text-sm font-mono text-surface-500 max-w-sm mb-6">
          {error.message || 'Something went wrong loading the topic rankings.'}
        </p>
