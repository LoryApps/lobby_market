...
import { BarChart2, BookOpen, Brain, Calendar, CalendarDays, Clock, Coins, Crown, Edit3, FileText, Flame, FlaskConical, Gavel, GitMerge, Globe, GraduationCap, HandshakeIcon, Hash, Link2, MessageSquare, Mic, Network, PenLine, Rocket, Scroll, Shield, Shuffle, Sparkles, Star, Swords, Target, Trophy, Wand2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 pb-24 md:pb-12">
        ...
        <section className="mt-6">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-mono text-base font-semibold text-white">
                  This Month&rsquo;s Rankings
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Monthly top voters, arguers, influencers, and lawmakers — browse past months too.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Full year champions — most votes, arguments, influence, and laws. Navigate past years.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who&rsquo;s climbing fastest this week — momentum over seniority.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top debaters, voters, and consensus maps — broken down by topic category.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top arguers ranked within each tag — see who leads on #climate, #ai, and more.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Oracle Predictions Leaderboard link */}
        <section className="mt-6">
          <Link
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top predictors by accuracy, volume, and Clout earned.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Thesis Oracle Leaderboard link */}
        <section className="mt-6">
          <Link
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top civic oracles ranked by thesis vindication accuracy.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who votes on the winning side most often? Ranked by outcome accuracy, volume, and contrarian genius.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* First-Move Accuracy link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/timing"
            className="flex items-center justify-between rounded-2xl border border-for-500/30 bg-for-500/5 px-6 py-5 hover:bg-for-500/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-for-500/10 border border-for-500/30 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who votes correctly before consensus forms? Ranked by early-vote accuracy within 48h of topic creation.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Argument Quality Leaderboard link */}
        <section className="mt-6">
          <Link
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  AI-graded argument rankings — who argues with the most clarity and evidence?
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top wiki editors, most-improved topics, and recent knowledge contributions.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  The most powerful alliances — ranked by influence, win rate, and size.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                  Civic Lawmakers
                  <span className="text-[10px] font-mono text-for-400 bg-for-600/15 border border-for-600/30 px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who helped the most topics become law? Ranked by co-authored laws via winning FOR votes.
                </p>
              </div>
            </div>
            <svg
        ...
        <section className="mt-6">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-emerald/10 border border-emerald/30 flex-shrink-0">
                <PenLine className="h-5 w-5 text-emerald" />
              </div>
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                  Amendment Architects
                  <span className="text-[10px] font-mono text-emerald bg-emerald/15 border border-emerald/30 px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who reshapes established laws? Ranked by amendments proposed, ratified, and voted on.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who evaluates the Codex? Ranked by reviews written, helpful votes, and star ratings given.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who stands behind the most laws? Ranked by formal civic endorsements across the Codex.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Founding Citizens link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/founders"
            className="flex items-center justify-between rounded-2xl border border-gold/40 bg-gradient-to-r from-gold/5 to-transparent px-6 py-5 hover:from-gold/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-gold/15 border border-gold/30 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Ranked by join order — Patriarchs, Pioneers, Vanguard, and Early Citizens.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Hall of Legends link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/legends"
            className="flex items-center justify-between rounded-2xl border border-gold/50 bg-gradient-to-r from-gold/10 to-transparent px-6 py-5 hover:from-gold/15 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-gold/20 border border-gold/40 flex-shrink-0">
                <Trophy className="h-5 w-5 text-gold" />
              </div>
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  All-time record holders across every dimension of civic excellence — no weekly resets.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Ambassador leaderboard link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/ambassadors"
            className="flex items-center justify-between rounded-2xl border border-emerald/40 bg-emerald/5 px-6 py-5 hover:bg-emerald/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-emerald/15 border border-emerald/30 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who&rsquo;s growing the Lobby the fastest? Top civic recruiters by conversions, signups, and Clout earned.
                </p>
              </div>
            </div>
            <svg
        ...
        <section className="mt-6">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                  Argument Arena Champions
                  <span className="text-[10px] font-mono text-gold bg-gold/15 border border-gold/30 px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who wins the most head-to-head argument faceoffs? Ranked by win rate across all matchups.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who earns the most clout winning bounties — and who funds the chase?
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who has truly changed the Lobby? Ranked by laws authored, reputation, and community reach.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Decathlon-style ranking — who participates most broadly across all civic dimensions?
                </p>
              </div>
            </div>
            <svg
        ...
        <section className="mt-6">
          <Link
            ...
            className="flex items-center justify-between rounded-2xl border border-against-500/40 bg-against-500/5 px-6 py-5 hover:bg-against-500/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-against-500/10 border border-against-500/30 flex-shrink-0">
                <Flame className="h-5 w-5 text-against-400" />
              ...
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                  Streak Masters
                  <span className="text-[10px] font-mono text-against-400 bg-against-500/15 border border-against-500/30 px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who&rsquo;s kept the flame alive longest? Ranked by consecutive daily voting streaks.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Bridge Builders link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/bridge"
            className="flex items-center justify-between rounded-2xl border border-emerald/30 bg-emerald/5 px-6 py-5 hover:bg-emerald/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-emerald/10 border border-emerald/30 flex-shrink-0">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  The Lobby&rsquo;s most principled contrarians — citizens who vote in the minority and argue their case.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Network Influence link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/network"
            className="flex items-center justify-between rounded-2xl border border-for-500/30 bg-for-500/5 px-6 py-5 hover:bg-for-500/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-for-500/10 border border-for-500/30 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who has the widest civic reach? Ranked by followers, estimated audience, and coalition bridging.
                </p>
              </div>
            </div>
            <svg
        ...
        <section className="mt-6">
          <Link
            href="/leaderboard/persuasion"
            className="flex items-center justify-between rounded-2xl border border-emerald/30 bg-emerald/5 px-6 py-5 hover:bg-emerald/10 transition-colors group"
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-emerald/10 border border-emerald/30 flex-shrink-0">
                <Mic className="h-5 w-5 text-emerald" />
              </div>
              <div>
                <p className="font-mono text-base font-semibold text-white flex items-center gap-2">
                  Most Persuasive Citizens
                  <span className="text-[10px] font-mono text-emerald bg-emerald/15 border border-emerald/30 px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                </p>
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Ranked by size-normalized argument upvotes — the Lobby&rsquo;s most effective voices.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Ranked by reputation score — earned through votes cast, topics authored, and laws passed.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Enduring quality contributions — law quality, argument longevity, and tenure consistency.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Who holds the most Clout — top earners and top givers this week.
                </p>
              </div>
            </div>
            <svg
        ...
        {/* Tribunal Leaderboard link */}
        <section className="mt-6">
          <Link
            href="/leaderboard/tribunal"
            className="flex items-center justify-between rounded-2xl border border-surface-300 bg-surface-100 px-6 py-5 hover:bg-surface-200 transition-colors group"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top jurors and challengers in the Civic Tribunal — who serves justice best?
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  The most trusted civic delegates — ranked by delegations received.
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-surface-500 mt-0.5">
                  Top AMA hosts ranked by sessions, answers, and community reach.
                </p>
              </div>
            </div>
            <svg
