...
export default function HeatmapError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 pb-24 md:pb-12 text-center">
        ...
        <h1 className="font-mono text-xl font-bold text-white mb-2">Heatmap unavailable</h1>
        <p className="text-sm text-surface-500 mb-6 font-mono max-w-sm mx-auto">
          Could not load heatmap data. Try again or explore trending topics.
        </p>
