...
const CHAPTERS: Chapter[] = [
  ...
  {
    number: 'Ch. 72',
    title: 'Prediction Market Analytics',
    subtitle: 'Personal deep-dive into your prediction market record — accuracy, Brier score, calibration chart, forecaster archetype, and category breakdown',
    accent: 'text-purple',
    borderColor: 'border-purple/30',
    bgColor: 'bg-purple/5',
    textColor: 'text-purple',
    items: [
      { icon: Target, label: 'New /analytics/predictions page — hero stats row: total predictions, accuracy %, avg Brier score (lower = better calibration), and total Clout earned. Forecaster Archetype badge: Oracle (75%+ accuracy), Analyst, Cautious, Contrarian, or Newcomer, each with a unique description and icon.', href: '/analytics/predictions', color: 'text-purple' },
      { icon: Scale, label: 'Calibration chart: confidence buckets (0–30%, 30–50%, 50–70%, 70–85%, 85–100%) vs actual accuracy. A perfectly calibrated forecaster\'s bars align with the centre line. Colour-coded deviation: gold = over-confident, red = under-confident, blue = well-calibrated.', href: '/analytics/predictions', color: 'text-for-400' },
      { icon: BarChart2, label: 'Category breakdown bars show predictions and accuracy per civic category. Best Calls and Missed Calls sections highlight highest-confidence correct and incorrect predictions. Tabbed resolved/active list shows full prediction history with outcome icons, confidence, and Clout earned. Added to analytics hub nav and command palette.', href: '/analytics/predictions', color: 'text-emerald' },
    ],
  },
  {
    number: 'Ch. 71',
    title: 'Debate Performance Analytics',
    subtitle: 'Personal breakdown of debates participated in — speaker vs viewer, sway voting, winner poll accuracy, and debate archetype',
    accent: 'text-purple',
    borderColor: 'border-purple/30',
    bgColor: 'bg-purple/5',
    textColor: 'text-purple',
    items: [
      { icon: Mic, label: 'New /analytics/debates page — four stat cards: debates joined, speaking appearances, sway votes cast, and winner polls accuracy. Debate Archetype badge: Prognosticator (65%+ winner poll accuracy), Orator (mostly speaker), Strategist (heavy sway voter), Observer, or Newcomer.', href: '/analytics/debates', color: 'text-purple' },
      { icon: BarChart2, label: 'Sway voting chart and winner poll accuracy gauge. Debate type breakdown (Quick / Grand / Tribunal) and category breakdown. Recent debates list showing role (speaker/viewer), side (FOR/AGAINST), debate outcome, and sway split bars.', href: '/analytics/debates', color: 'text-for-400' },
      { icon: Gavel, label: 'Link added to analytics hub and command palette under "Debate Stats". Debate analytics page backed by new /api/analytics/debates route computing all stats from the debates, debate_participants, debate_sway_votes, and debate_winner_polls tables.', href: '/analytics/debates', color: 'text-gold' },
    ],
  },
  {
    number: 'Ch. 70',
    title: 'Argument Faceoff Analytics',
    subtitle: 'Personal head-to-head faceoff record — win rate, head-to-head breakdown, faceoff history, and Judge archetype',
    accent: 'text-against-400',
    borderColor: 'border-against-500/30',
    bgColor: 'bg-against-500/5',
    textColor: 'text-against-300',
    items: [
      { icon: Swords, label: 'New /analytics/faceoffs page — hero stats: total bouts judged, unique arguments seen, total faceoffs recorded. Judge Archetype: Consistent Judge (strong patterns), Balanced (near-even FOR/AGAINST choices), Side Loyalist, Active Judge, or Newcomer.', href: '/analytics/faceoffs', color: 'text-against-400' },
      { icon: Activity, label: 'FOR-bias vs AGAINST-bias chart showing how often you pick FOR/AGAINST arguments as winner. Faceoff history list with participant argument cards, outcome indicator, and links to full arguments. Link added to analytics hub and command palette.', href: '/analytics/faceoffs', color: 'text-for-400' },
    ],
  },
  {
    number: 'Ch. 69',
    title: 'Vote History Analytics',
    subtitle: 'Deep-dive on when and how you vote — weekly chart, day-of-week heatmap, hour-of-day distribution, and majority vs contrarian breakdown',
    accent: 'text-for-400',
    borderColor: 'border-for-500/30',
    bgColor: 'bg-for-500/5',
    textColor: 'text-for-300',
    items: [
      { icon: Vote, label: 'New /analytics/votes page — stat cards: total votes, current streak, majority rate (% matching platform consensus), and contrarian rate. Weekly vote volume chart (last 26 weeks) with FOR/AGAINST bars. Milestone timeline showing 1st, 10th, 100th vote with dates.', href: '/analytics/votes', color: 'text-for-400' },
      { icon: BarChart2, label: 'Day-of-week heatmap showing your most active civic days. Hour-of-day distribution bar chart (12am–11pm). Majority vs Contrarian donut showing how often you vote with or against the crowd. Link added to analytics hub nav and command palette.', href: '/analytics/votes', color: 'text-emerald' },
    ],
  },
  {
    number: 'Ch. 68',
    title: 'Coalition Analytics',
    subtitle: 'Stance win rate, member alignment, and category performance across all coalitions you belong to',
    accent: 'text-purple',
    borderColor: 'border-purple/30',
    bgColor: 'bg-purple/5',
    textColor: 'text-purple',
    items: [
      { icon: Users, label: 'New /analytics/coalitions page — lists every coalition you\'re a member of with stance win rate (% of coalition-backed topics that became law), member alignment score (how consistently coalition members vote together), and total stance positions taken.', href: '/analytics/coalitions', color: 'text-purple' },
      { icon: Shield, label: 'Category breakdown shows which civic categories your coalitions are most active in and their law conversion rates. Coalition Archetype: Power Bloc (high win rate), Persistent (many stances), Niche Specialist (concentrated category), Active Member, or Newcomer. Link added to analytics hub and command palette.', href: '/analytics/coalitions', color: 'text-for-400' },
    ],
  },
  {
    number: 'Ch. 62',
