...
const RECENT_BUILDS: RecentBuild[] = [
  {
    ...
    description: 'Dedicated shareable page for every citizen\'s civic achievement collection — filterable by branch, tier progress bar, and direct URL for sharing.',
  ...
  {
    title: 'Civic Fingerprint',
    description: 'How unique is your civic voice? See exactly how your votes diverge from the platform consensus category by category.',
    href: '/fingerprint',
    icon: Fingerprint,
    color: 'text-purple',
    tag: 'Analytics',
  ...
  {
    title: 'Law Compare',
    description: 'Side-by-side comparison of any two established laws — vote splits, argument counts, top voices, and key differences.',
    href: '/law/compare',
    icon: Scale,
    color: 'text-for-400',
    tag: 'Law Codex',
  ...
  {
    title: 'Why People Voted',
    description: 'AI-synthesised analysis of the stated reasons behind every vote on a topic — what really drove the consensus.',
    href: '/topic',
    icon: FileText,
    color: 'text-emerald',
    tag: 'Insights',
  ...
  {
    title: 'Civic Certificate',
    description: 'Earn a personalised certificate of contribution for every law you helped pass — frame it, share it, prove you shaped the Lobby.',
    href: '/certificate',
    icon: Award,
    color: 'text-gold',
    tag: 'Recognition',
  ...
  {
    title: 'Monthly Civic Digest',
    description: 'Your personal month-in-review: laws passed, top arguments, vote record, and biggest civic moments — auto-generated each month.',
    href: '/monthly',
    icon: Calendar,
    color: 'text-for-400',
    tag: 'Analytics',
  ...
  {
    title: 'Expanded Achievement Catalog',
    description: '23 new civic achievements across 6 branches: Voter, Orator, Scholar, Economist, Strategist, and Citizen. Branch mastery tabs on the achievements page.',
    href: '/achievements',
    icon: Award,
    color: 'text-purple',
    tag: 'Gamification',
