...
export default function WelcomeError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-surface-50 flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="font-mono text-xl font-bold text-white mb-2">Welcome unavailable</h1>
      <p className="text-sm text-surface-500 mb-6 max-w-xs">
        Something went wrong loading your civic profile. You can still explore the platform.
      </p>
