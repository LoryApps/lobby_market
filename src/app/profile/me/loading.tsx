    ...
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-6 pb-24 md:pb-12">
        ...
        <div className="rounded-2xl bg-surface-100 border border-surface-300 p-6 mb-5">
          ...
          {/* Stats row */}
          <div className="grid grid-cols-4 gap-3 mt-5 pt-4 border-t border-surface-300">
        ...
        <div className="rounded-2xl bg-surface-100 border border-surface-300 p-5">
          ...
          <div className="space-y-3">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 py-2 border-b border-surface-300 last:border-0">
