...
export type FeedMode = "discover" | "following" | "foryou" | "mytags" | "unvoted" | "battleground" | "rising" | "closingin" | "newlaws" | "collapse" | "argued" | "flux" | "lastcall" | "momentum" | "mandate" | "elders" | "groundswell" | "livedebates" | "swing" | "stalled";
    ...
    (set, get) => ({
      ...
      setFeedMode: (feedMode) => {
        ...
        const sort = (feedMode === "following" || feedMode === "mytags") ? "new"
          ...
          : (feedMode === "rising" || feedMode === "closingin" || feedMode === "newlaws" || feedMode === "collapse" || feedMode === "argued" || feedMode === "flux" || feedMode === "lastcall" || feedMode === "mandate" || feedMode === "elders" || feedMode === "groundswell" || feedMode === "livedebates" || feedMode === "swing" || feedMode === "stalled") ? "top"
          : "top";
        set({
          feedMode,
          sort,
